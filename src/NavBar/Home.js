...
function Home() {
  return (
    ...
    <div className='facts '>
      ...
      <Card 
      // imgsrc={facts}
      imgsrc="https://images.newindianexpress.com/uploads/user/imagelibrary/2022/10/29/w1200X800/himalaya_1.jpg"
      />
      </Link>
      </div>
      <div className='b'>
      ...
      <Facts
      // imgsrc={trek}
      imgsrc="https://www.thrillophilia.com/blog/wp-content/uploads/2015/01/Everest-base-camp.jpg"
      ...
      <Facts
      // imgsrc={animals}
      imgsrc="https://t2.ea.ltmcdn.com/en/posts/7/9/1/the_himalayan_bears_1197_3_600.jpg"
    ...
    <div className='latestdiv'>
      ...
      <Card1
      // imgsrc={katmandu}
      imgsrc="https://soulitude.in/wp-content/uploads/soulitude-in-the-himalayas-property-img.jpg"
      ...
      <Card1
      // imgsrc={mount}
      imgsrc="https://renokadventures.com/image/himalayas-view.webp"
      ...
      <Card1
      // imgsrc={water}
      imgsrc="https://www.himalayanwonders.com/siteblog/wp-content/uploads/2021/04/man-using-filtration-system-640x427.jpg"
      ...
      <Link to='/History'>
      <div className='his'>
        <img src="https://i.ytimg.com/vi/lCzKCLA9Sxo/maxresdefault.jpg" height="400px"/>
      </div>
      </Link>
      ...
      <Card2
      // imgsrc={roop}
      imgsrc="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnfnr6KxrNcMqIRWcapwo2_7sHpGnAY9rBxw&usqp=CAU"
      head="Roopkund Lake"
